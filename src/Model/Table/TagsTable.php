 ...
 * Tags Model
 *
 * @property \App\Model\Table\AthletesTable|\Cake\ORM\Association\BelongsToMany $Athletes
 *
...
class TagsTable extends Table
{
    ...
    public function initialize(array $config)
    {
		...
		$this->addBehavior('Translate', ['fields' => ['last_name']]);
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->add('last_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['last_name']));
