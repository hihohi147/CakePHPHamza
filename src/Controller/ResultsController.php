...
class ResultsController extends AppController
{
    ...
    public function add()
    {
        ...
        $athletes = $this->Results->Athletes->find('list', ['limit' => 200]);
        $sports = $this->Results->Sports->find('list', ['limit' => 200]);
        $this->set(compact('result', 'athletes', 'sports'));
    }
